---
name: sop-creator
description: Transforms a process description into a structured, step-by-step Standard Operating Procedure at 5th-grade reading level.
role: ceo
trigger: user needs to document a business process, create an operational guide, or write repeatable workflow instructions
---
...
### Pre-Execution Check
- [ ] I gathered any available business context from the user's message or prior answers
...
- **Version:** 1.0
- **Author:** "Process Owner" unless the user specifies otherwise
- **Last Updated:** Current date
