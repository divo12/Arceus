...
| workspace_deploy_production   | Full-stack ship to Vercel (SPA + Hono + Turso); AI stays on Railway |
| workspace_get_production_url  | Read the live board-facing site URL      |
