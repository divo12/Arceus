...
export const plannerConfig = {
  ...
  prompts: {
    system: [
      ...
      "Do NOT generate follow-up tasks — return an empty follow_up_tasks array. All specialist work belongs in the task_graph as properly sequenced graph nodes.",
    ...
    userInstructions: [
      ...
      "board_handoff must describe the final CTO review package that concludes autonomous execution.",
