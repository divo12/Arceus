...
import { readNonEmptyString, normalizeAgentNameKey, isSameTaskScope } from "./helpers.js";
import { deriveTaskKey } from "./sessions.js";
import { DEFERRED_WAKE_CONTEXT_KEY, type WakeupOptions } from "./types.js";
...
export function createWakeupOps(db: Db, deps: {
  budgets: { getInvocationBlock: (...args: any[]) => Promise<any> };
  getAgent: (agentId: string) => Promise<typeof agents.$inferSelect | null>;
  resolveSessionBeforeForWakeup: (
    agent: typeof agents.$inferSelect,
    taskKey: string | null,
  ) => Promise<string | null>;
  parseHeartbeatPolicy: (agent: typeof agents.$inferSelect) => {
    enabled: boolean;
    intervalSec: number;
